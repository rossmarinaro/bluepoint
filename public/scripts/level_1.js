...
// other animations for guy blue
    ...
    NPCS.forEach(el => {
        ...
        timedEvent = this.time.delayedCall(144000 + initialTime, () =>  player.avatar.play("collapse" + player.shirt));
    ...
    // camera zoom in again
        ...
        timedEvent = this.time.delayedCall(164000 + initialTime, () => player.avatar.play("standUp" + player.shirt));
